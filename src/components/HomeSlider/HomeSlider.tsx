...
const HomeSlider = () => {
  ...
  return (
    <>
      ...
      <div className="w-full mt-20 flex justify-start items-start md:px-36 lg:px-36 px-10 bg-[linear-gradient(to_left_bottom,rgba(248,147,32,0.6),rgba(248,147,32,0.6),rgba(248,147,32,0.8)),url('https://res.cloudinary.com/owujib/image/upload/v1680478882/ai-saturdays-imgs/Group_1_nqp4ec.jpg')] bg-no-repeat bg-cover">
        <div className="py-14">
          <div className="md:w-[100%] lg:w-[100%] h-[200px] flex items-center justify-center w-full ">
            <div className="w-[100%] md:w-full">
              <h1 className="text-2xl md:text-4xl my-3 font-bold text-white mb-7">
                AI Saturdays Lagos
                <br />
                <span className="font-medium text-[0.75em]">
                  Aimed at empowering Africa to excel in AI and lead the way in
